...
rm -rf src/third_party/gtest; svn checkout http://googletest.googlecode.com/svn/trunk@605 src/third_party/gtest
rm -rf src/third_party/gyp; svn checkout http://gyp.googlecode.com/svn/trunk@1167 src/third_party/gyp
rm -rf src/third_party/jsoncpp; svn checkout http://jsoncpp.svn.sourceforge.net/svnroot/jsoncpp/trunk/jsoncpp@230 src/third_party/jsoncpp
